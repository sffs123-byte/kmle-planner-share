...
body.vaccine-spell-body .main, body.vaccine-spell-body .quiz-header {{ position: relative; z-index: 1; }}
body.vaccine-spell-body .quiz-overlay {{ position: fixed; z-index: 200; }}
